    ...
    return (
        ...
        >
            <form className="m-0 flex-1 bg-purple-3 flex flex-col items-center justify-start pt-[6.25rem] px-[1.25rem] pb-[0rem] box-border gap-[1.5rem] shrink-0 max-w-full z-[2] mq750:pt-[4.063rem] mq750:box-border" onSubmit={handleSubmit}>
                    ...
                    <div className="w-[25.625rem] flex flex-col items-start justify-start pt-[0.187rem] px-[0rem] pb-[0rem] box-border min-w-[25.625rem] max-w-full lg:flex-1 mq750:min-w-full">
                        <div className="self-stretch flex flex-col items-start justify-start gap-[2rem] mq450:gap-[1rem]">
                            <div className="w-[10.563rem] flex flex-row items-start justify-between gap-[1.25rem] z-[1]">
                                <div className="w-[4.375rem] mq750:mx-14 flex flex-col items-start justify-start gap-[0.125rem]">
                                    <div className="relative text-[1.25rem] font-semibold font-text-sm-bold text-primary-full text-left inline-block min-w-[4.313rem] mq450:text-[1rem] hid">
                                        Sign In
                                    </div>
                            ...
                            <div className="self-stretch flex flex-col mq450:flex-col-reverse items-start justify-start gap-[1.75rem]">
                                ...
                                <div className="self-stretch flex flex-col items-start justify-start gap-[1rem] mq450:order-5">
                                    ...
                                    <div className="w-[25.625rem] hidden flex-col items-start justify-start gap-[1.5rem] max-w-full mq450:flex">
                ...
                <div className="w-[77.5rem] flex flex-row mq450:flex--reverse items-start justify-between max-w-full gap-[1.25rem]  lg:flex-wrap mq450:order-4" >
                    ...
                    <div className="w-[25.625rem] flex flex-col items-start justify-start gap-[1.5rem] max-w-full mq450:hidden">
                        <div className="self-stretch flex flex-row items-start justify-between gap-[1.25rem] mq450:flex-wrap">
                            <div className="flex flex-row items-start justify-start gap-[0.5rem]">
                                <input
                                    className="m-0 h-[1rem] w-[1rem] relative z-[1] accent-plum"
